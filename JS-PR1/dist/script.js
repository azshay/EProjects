...
/* harmony import */ var _modules_checkPhone__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/checkPhone */ "./src/js/modules/checkPhone.js");
...
window.addEventListener("DOMContentLoaded", function () {
  var modalState = {};
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])(".popup_engineer_btn", ".popup_engineer", ".popup_engineer .popup_close");
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])(".phone_link", ".popup", ".popup .popup_close");
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])(".glazing_price_btn", ".popup_calc", ".popup_calc_close");
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])(".popup_calc .popup_calc_button", ".popup_calc_profile", ".popup_calc_profile_close");
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close");
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_1__["default"])(modalState);
  Object(_modules_checkPhone__WEBPACK_IMPORTED_MODULE_2__["default"])('[name="user_phone"]');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".glazing_block", ".glazing_content");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".balcon_icons_img", ".big_img img", "do_image_more");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".decoration_item", ".decoration_content > div > div", "after_click");
  Object(_modules_checkInputText__WEBPACK_IMPORTED_MODULE_4__["default"])(".popup_calc input", "numbers");
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_5__["default"])(modalState);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])("2022-09-23 11:0");
});
...
var changeModalState = function changeModalState(state) {
  ...
  var createData = function createData(event, element, property) {
        ...
        switch (event) {
          ...
          case "change":
            if (item.classList.contains("checkbox")) {
              ...
              element.forEach(function (elem, j) {
                if (i !== j) {
                  elem.checked = false;
                }
              });
...
var checkInputText = function checkInputText(selector, needText) {
...
var checkPhone = function checkPhone(selector) {
...
var modal = function modal(triggerSelector, modalTriggerSelector, closeTriggerSelector) {
  var allModalsSelector = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "[data-modal]";
...
var tabs = function tabs(triggersSelector, contentSelector) {
  ...
  triggers.forEach(function (trigger, i) {
    trigger.addEventListener("click", function () {
      ...
      newTriggers.forEach(function (activeTrigger) {
      ...
      content.forEach(function (item, j) {
        if (i != j) {
          item.style.display = "none";
        } else {
          item.style.display = "block";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(lastDate) {
  var days = document.querySelector("#days"),
      hours = document.querySelector("#hours"),
      minutes = document.querySelector("#minutes"),
      seconds = document.querySelector("#seconds");
  var currentDate = new Date();
  var deadline = new Date(lastDate);
  ...
  var checkNull = function checkNull(string) {
