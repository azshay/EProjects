...
/* harmony import */ var _modules_showStyles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/showStyles */ "./src/js/modules/showStyles.js");
...
/* harmony import */ var _modules_changeImage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/changeImage */ "./src/js/modules/changeImage.js");
...
/* harmony import */ var _modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/checkTextInputs */ "./src/js/modules/checkTextInputs.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_showStyles__WEBPACK_IMPORTED_MODULE_1__["default"])(".button-styles", ["col-sm-3", "col-sm-offset-0", "col-xs-10", "col-xs-offset-1"], ".styles-2", ["hidden-lg", "hidden-md", "hidden-sm", "hidden-xs"]);
  Object(_modules_calculator__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".portfolio-block", ".portfolio-menu", "active", ".portfolio-no");
  Object(_modules_changeImage__WEBPACK_IMPORTED_MODULE_4__["default"])(".sizes-block");
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_5__["default"])("ui-accordion-header-active", "ui-accordion-content-active", ".accordion-heading", ".accordion-block");
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_6__["default"])(".feedback-slider-item", "horizontal", ".main-prev-btn", ".main-next-btn");
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_9__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_9__["default"])('[name="message"]');
});
...
var accordion = function accordion(headingActive, blockActive, headingSelector, blockSelector) {
...
var calculator = function calculator() {
  ...
  var calc = function calc() {
    ...
    if (selectSize.value !== selectSize[0].value && selectMaterial.value !== selectMaterial[0].value) {
      priceText.textContent = price;
    } else {
      priceText.textContent = "Для расчета нужно выбрать размер картины и материал картины";
    }
  };
};
...
var changeImage = function changeImage(blockToChangeSelector) {
  var blocksToChange = document.querySelectorAll(blockToChangeSelector);
  blocksToChange.forEach(function (blockToChange, i) {
    blockToChange.style.transition = "1s";
    blockToChange.addEventListener("mouseenter", function () {
      blockToChange.style.opacity = "0";
      setTimeout(function () {
        blockToChange.firstElementChild.src = "assets/img/sizes-".concat(i + 1, "-1.png");
        blockToChange.style.opacity = "1";
      }, 500);
    });
    blockToChange.addEventListener("mouseleave", function () {
      blockToChange.style.opacity = "0";
      setTimeout(function () {
        blockToChange.firstElementChild.src = "assets/img/sizes-".concat(i + 1, ".png");
        blockToChange.style.opacity = "1";
      }, 500);
    });
  });
...
var modal = function modal() {
  // Специфичный код!
  var needModal = true; // Специфичный код!

  var bindModal = function bindModal(modalTriggersSelector, modalWindowSelector, closeTriggerSelector) {
    var modalTriggers = document.querySelectorAll(modalTriggersSelector),
        modalWindow = document.querySelector(modalWindowSelector),
        closeTrigger = document.querySelector(modalWindowSelector + " " + closeTriggerSelector);
    modalWindow.classList.add("animated", "fadeIn");
    modalTriggers.forEach(function (modalTrigger) {
      modalTrigger.addEventListener("click", function () {
        modalWindow.style.display = "block";
        document.body.style.overflow = "hidden"; // Удалить, если код будет переиспользоваться!
    ...
    }, 60000); // Специфичный код!
  };

  function openByScroll(selector) {
    window.addEventListener("scroll", function () {
      if (needModal && window.scrollY + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
...
var showStyles = function showStyles(triggerSelector, newClassListArray, hiddenElementsTrigger, hiddenElementsClassesArray) {
  var trigger = document.querySelector(triggerSelector),
      hiddenElements = document.querySelectorAll(hiddenElementsTrigger);
  trigger.addEventListener("click", function () {
    hiddenElements.forEach(function (element) {
      for (var i = 0; i < hiddenElementsClassesArray.length; i++) {
        element.classList.remove(hiddenElementsClassesArray[i]);
      }

      for (var _i = 0; _i < newClassListArray.length; _i++) {
        element.classList.add(newClassListArray[_i]);
      }
    });
    trigger.remove();
  });
...
var sliders = function sliders(slidesSelector, dir, prevSelector, nextSelector) {
  ...
  var currentInterval;
  slides[0].parentElement.addEventListener("mouseenter", function () {
    clearInterval(currentInterval);
  });
  slides[0].parentElement.addEventListener("mouseleave", function () {
    autoNext();
  });
  ...
  var reRender = function reRender() {
    var animateClass = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
...
var tabs = function tabs(tabsContentSelector, tabsTriggersSelector, activeClass, blockNoPortfolioSelector) {
  ...
  tabsTriggerMenu.addEventListener("click", function (event) {
    var counter = 0;
    blockNoPortfolio.style.display = "none";

    if (!event.target.classList.contains(tabsTriggersSelector)) {
      tabsTriggers.forEach(function (tabTrigger) {
